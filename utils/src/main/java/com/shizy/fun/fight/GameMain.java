package com.shizy.fun.fight;

import com.shizy.fun.fight.menu.FightInfo;
import com.shizy.fun.fight.menu.FightMenu;
import com.shizy.fun.fight.role.Goblin;
import com.shizy.fun.fight.role.RoleBase;
import com.shizy.fun.fight.role.Swordman;
